...
class AutoGPT:
    ...
    def __init_prompt_templates(self):
        ...
        self.ask_prompt = PromptTemplate.from_file(
            self.ask_prompt_file
        )
    ...
    def __init_chains(self):
        ...
        # 提出问题的chain
        self.ask_chain = (self.ask_prompt | self.llm | StrOutputParser())
        # 最终一步的chain
    ...
    def __ask_step(self, short_term_memory, task_description) -> str:
        """提出问题, 生成思考的问题"""
